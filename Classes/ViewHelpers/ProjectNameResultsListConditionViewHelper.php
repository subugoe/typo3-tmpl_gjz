...
class ProjectNameResultsListConditionViewHelper extends AbstractViewHelper {
	...
	public function render() {
		...
		if ( (strpos($result, "idz") !== FALSE) ) {
			$imageName = "IdZ 18 (1975-1986)";
			return $imageName;
		}
		elseif ( (strpos($result, "idrz") !== FALSE) ) {
			$imageName = "IdRZ 18 (1987-2007)";
			return $imageName;
		}
		elseif ( (strpos($result, "gjz") !== FALSE) ) {
			$imageName = "GJZ 18 (seit 2011)";
			return $imageName;
		}
