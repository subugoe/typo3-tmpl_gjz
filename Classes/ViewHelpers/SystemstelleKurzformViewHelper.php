...
class Tx_Find_ViewHelpers_SystemstelleKurzformViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	...
	public function render() {
		...
		if ( in_array($firstChar, $digits) ) {
			...
			$result = (string)substr($result, 0, $secondSpacePos+1);
			...
			$result = (string)substr($result, 0, $thirdSpacePos+1);
